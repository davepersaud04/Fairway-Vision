...
type Props = NativeStackScreenProps<RootStackParamList, ScreenName.ConnHotSpot>


const ConnHotSpot = ({ route, navigation }: Props) => {
    ...
    const handleContinue = () => {
        navigation.navigate(ScreenName.ConnHotSpotP2, {});
    };
